...
-- Create countries table with all ISO fields
CREATE TABLE countries (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    name TEXT NOT NULL,
    alpha2_code CHAR(2) UNIQUE NOT NULL,
    alpha3_code CHAR(3) UNIQUE NOT NULL,
...
CREATE INDEX idx_countries_alpha3 ON countries(alpha3_code);
CREATE INDEX idx_countries_name ON countries(name);
CREATE INDEX idx_countries_region ON countries(region);
CREATE INDEX idx_countries_sub_region ON countries(sub_region);

-- Insert all countries from ISO dataset
INSERT INTO countries (name, alpha2_code, alpha3_code, country_code, iso_3166_2, region, sub_region, intermediate_region, region_code, sub_region_code, intermediate_region_code) VALUES
...
('Australia', 'AU', 'AUS', 36, 'ISO 3166-2:AU', 'Oceania', 'Australia and New Zealand', NULL, 9, 53, NULL),
...
('Bhutan', 'BT', 'BTN', 64, 'ISO 3166-2:BT', 'Asia', 'Southern Asia', NULL, 142, 34, NULL),
...
('Bosnia and Herzegovina', 'BA', 'BIH', 70, 'ISO 3166-2:BA', 'Europe', 'Southern Europe', NULL, 150, 39, NULL),
('Botswana', 'BW', 'BWA', 72, 'ISO 3166-2:BW', 'Africa', 'Sub-Saharan Africa', 'Southern Africa', 2, 202, 18),
('Bouvet Island', 'BV', 'BVT', 74, 'ISO 3166-2:BV', NULL, NULL, NULL, NULL, NULL, NULL),
('Brazil', 'BR', 'BRA', 76, 'ISO 3166-2:BR', 'Americas', 'Latin America and the Caribbean', 'South America', 19, 419, 5),
('British Indian Ocean Territory', 'IO', 'IOT', 86, 'ISO 3166-2:IO', NULL, NULL, NULL, NULL, NULL, NULL),
('Brunei Darussalam', 'BN', 'BRN', 96, 'ISO 3166-2:BN', 'Asia', 'South-eastern Asia', NULL, 142, 35, NULL),
...
('Cambodia', 'KH', 'KHM', 116, 'ISO 3166-2:KH', 'Asia', 'South-eastern Asia', NULL, 142, 35, NULL),
('Cameroon', 'CM', 'CMR', 120, 'ISO 3166-2:CM', 'Africa', 'Sub-Saharan Africa', 'Middle Africa', 2, 202, 17),
('Canada', 'CA', 'CAN', 124, 'ISO 3166-2:CA', 'Americas', 'Northern America', NULL, 19, 21, NULL),
...
('China', 'CN', 'CHN', 156, 'ISO 3166-2:CN', 'Asia', 'Eastern Asia', NULL, 142, 30, NULL),
('Christmas Island', 'CX', 'CXR', 162, 'ISO 3166-2:CX', NULL, NULL, NULL, NULL, NULL, NULL),
('Cocos (Keeling) Islands', 'CC', 'CCK', 166, 'ISO 3166-2:CC', NULL, NULL, NULL, NULL, NULL, NULL),
...
('Cook Islands', 'CK', 'COK', 184, 'ISO 3166-2:CK', 'Oceania', 'Polynesia', NULL, 9, 61, NULL),
...
('Croatia', 'HR', 'HRV', 191, 'ISO 3166-2:HR', 'Europe', 'Southern Europe', NULL, 150, 39, NULL),
...
('Fiji', 'FJ', 'FJI', 242, 'ISO 3166-2:FJ', 'Oceania', 'Melanesia', NULL, 9, 54, NULL),
...
('French Polynesia', 'PF', 'PYF', 258, 'ISO 3166-2:PF', 'Oceania', 'Polynesia', NULL, 9, 61, NULL),
('French Southern Territories', 'TF', 'ATF', 260, 'ISO 3166-2:TF', NULL, NULL, NULL, NULL, NULL, NULL),
...
('Gibraltar', 'GI', 'GIB', 292, 'ISO 3166-2:GI', 'Europe', 'Southern Europe', NULL, 150, 39, NULL),
('Greece', 'GR', 'GRC', 300, 'ISO 3166-2:GR', 'Europe', 'Southern Europe', NULL, 150, 39, NULL),
('Greenland', 'GL', 'GRL', 304, 'ISO 3166-2:GL', 'Americas', 'Northern America', NULL, 19, 21, NULL),
...
('Guam', 'GU', 'GUM', 316, 'ISO 3166-2:GU', 'Oceania', 'Micronesia', NULL, 9, 57, NULL),
('Guatemala', 'GT', 'GTM', 320, 'ISO 3166-2:GT', 'Americas', 'Latin America and the Caribbean', 'Central America', 19, 419, 13),
('Guernsey', 'GG', 'GGY', 831, 'ISO 3166-2:GG', 'Europe', 'Northern Europe', NULL, 150, 154, NULL),
...
('Heard Island and McDonald Islands', 'HM', 'HMD', 334, 'ISO 3166-2:HM', NULL, NULL, NULL, NULL, NULL, NULL),
('Holy See', 'VA', 'VAT', 336, 'ISO 3166-2:VA', 'Europe', 'Southern Europe', NULL, 150, 39, NULL),
('Honduras', 'HN', 'HND', 340, 'ISO 3166-2:HN', 'Americas', 'Latin America and the Caribbean', 'Central America', 19, 419, 13),
('Hong Kong', 'HK', 'HKG', 344, 'ISO 3166-2:HK', 'Asia', 'Eastern Asia', NULL, 142, 30, NULL),
...
('India', 'IN', 'IND', 356, 'ISO 3166-2:IN', 'Asia', 'Southern Asia', NULL, 142, 34, NULL),
('Indonesia', 'ID', 'IDN', 360, 'ISO 3166-2:ID', 'Asia', 'South-eastern Asia', NULL, 142, 35, NULL),
('Iran (Islamic Republic of)', 'IR', 'IRN', 364, 'ISO 3166-2:IR', 'Asia', 'Southern Asia', NULL, 142, 34, NULL),
...
('Italy', 'IT', 'ITA', 380, 'ISO 3166-2:IT', 'Europe', 'Southern Europe', NULL, 150, 39, NULL),
('Jamaica', 'JM', 'JAM', 388, 'ISO 3166-2:JM', 'Americas', 'Latin America and the Caribbean', 'Caribbean', 19, 419, 29),
('Japan', 'JP', 'JPN', 392, 'ISO 3166-2:JP', 'Asia', 'Eastern Asia', NULL, 142, 30, NULL),
('Jersey', 'JE', 'JEY', 832, 'ISO 3166-2:JE', 'Europe', 'Northern Europe', NULL, 150, 154, NULL),
...
('Kiribati', 'KI', 'KIR', 296, 'ISO 3166-2:KI', 'Oceania', 'Micronesia', NULL, 9, 57, NULL),
('Korea (Democratic People''s Republic of)', 'KP', 'PRK', 408, 'ISO 3166-2:KP', 'Asia', 'Eastern Asia', NULL, 142, 30, NULL),
('Korea, Republic of', 'KR', 'KOR', 410, 'ISO 3166-2:KR', 'Asia', 'Eastern Asia', NULL, 142, 30, NULL),
...
('Lao People''s Democratic Republic', 'LA', 'LAO', 418, 'ISO 3166-2:LA', 'Asia', 'South-eastern Asia', NULL, 142, 35, NULL),
...
('Macao', 'MO', 'MAC', 446, 'ISO 3166-2:MO', 'Asia', 'Eastern Asia', NULL, 142, 30, NULL),
...
('Malaysia', 'MY', 'MYS', 458, 'ISO 3166-2:MY', 'Asia', 'South-eastern Asia', NULL, 142, 35, NULL),
('Maldives', 'MV', 'MDV', 462, 'ISO 3166-2:MV', 'Asia', 'Southern Asia', NULL, 142, 34, NULL),
('Mali', 'ML', 'MLI', 466, 'ISO 3166-2:ML', 'Africa', 'Sub-Saharan Africa', 'Western Africa', 2, 202, 11),
('Malta', 'MT', 'MLT', 470, 'ISO 3166-2:MT', 'Europe', 'Southern Europe', NULL, 150, 39, NULL),
('Marshall Islands', 'MH', 'MHL', 584, 'ISO 3166-2:MH', 'Oceania', 'Micronesia', NULL, 9, 57, NULL),
...
('Micronesia (Federated States of)', 'FM', 'FSM', 583, 'ISO 3166-2:FM', 'Oceania', 'Micronesia', NULL, 9, 57, NULL),
...
('Mongolia', 'MN', 'MNG', 496, 'ISO 3166-2:MN', 'Asia', 'Eastern Asia', NULL, 142, 30, NULL),
('Montenegro', 'ME', 'MNE', 499, 'ISO 3166-2:ME', 'Europe', 'Southern Europe', NULL, 150, 39, NULL),
...
('Myanmar', 'MM', 'MMR', 104, 'ISO 3166-2:MM', 'Asia', 'South-eastern Asia', NULL, 142, 35, NULL),
('Namibia', 'NA', 'NAM', 516, 'ISO 3166-2:NA', 'Africa', 'Sub-Saharan Africa', 'Southern Africa', 2, 202, 18),
('Nauru', 'NR', 'NRU', 520, 'ISO 3166-2:NR', 'Oceania', 'Micronesia', NULL, 9, 57, NULL),
('Nepal', 'NP', 'NPL', 524, 'ISO 3166-2:NP', 'Asia', 'Southern Asia', NULL, 142, 34, NULL),
('Netherlands', 'NL', 'NLD', 528, 'ISO 3166-2:NL', 'Europe', 'Western Europe', NULL, 150, 155, NULL),
('New Caledonia', 'NC', 'NCL', 540, 'ISO 3166-2:NC', 'Oceania', 'Melanesia', NULL, 9, 54, NULL),
('New Zealand', 'NZ', 'NZL', 554, 'ISO 3166-2:NZ', 'Oceania', 'Australia and New Zealand', NULL, 9, 53, NULL),
...
('Niue', 'NU', 'NIU', 570, 'ISO 3166-2:NU', 'Oceania', 'Polynesia', NULL, 9, 61, NULL),
('Norfolk Island', 'NF', 'NFK', 574, 'ISO 3166-2:NF', 'Oceania', 'Australia and New Zealand', NULL, 9, 53, NULL),
('North Macedonia', 'MK', 'MKD', 807, 'ISO 3166-2:MK', 'Europe', 'Southern Europe', NULL, 150, 39, NULL),
('Northern Mariana Islands', 'MP', 'MNP', 580, 'ISO 3166-2:MP', 'Oceania', 'Micronesia', NULL, 9, 57, NULL),
...
('Pakistan', 'PK', 'PAK', 586, 'ISO 3166-2:PK', 'Asia', 'Southern Asia', NULL, 142, 34, NULL),
('Palau', 'PW', 'PLW', 585, 'ISO 3166-2:PW', 'Oceania', 'Micronesia', NULL, 9, 57, NULL),
...
('Papua New Guinea', 'PG', 'PNG', 598, 'ISO 3166-2:PG', 'Oceania', 'Melanesia', NULL, 9, 54, NULL),
('Paraguay', 'PY', 'PYR', 600, 'ISO 3166-2:PY', 'Americas', 'Latin America and the Caribbean', 'South America', 19, 419, 5),
('Peru', 'PE', 'PER', 604, 'ISO 3166-2:PE', 'Americas', 'Latin America and the Caribbean', 'South America', 19, 419, 5),
('Philippines', 'PH', 'PHL', 608, 'ISO 3166-2:PH', 'Asia', 'South-eastern Asia', NULL, 142, 35, NULL),
('Pitcairn', 'PN', 'PCN', 612, 'ISO 3166-2:PN', 'Oceania', 'Polynesia', NULL, 9, 61, NULL),
('Poland', 'PL', 'POL', 616, 'ISO 3166-2:PL', 'Europe', 'Eastern Europe', NULL, 150, 151, NULL),
('Portugal', 'PT', 'PRT', 620, 'ISO 3166-2:PT', 'Europe', 'Southern Europe', NULL, 150, 39, NULL),
...
('Saint Pierre and Miquelon', 'PM', 'SPM', 666, 'ISO 3166-2:PM', 'Americas', 'Northern America', NULL, 19, 21, NULL),
('Saint Vincent and the Grenadines', 'VC', 'VCT', 670, 'ISO 3166-2:VC', 'Americas', 'Latin America and the Caribbean', 'Caribbean', 19, 419, 29),
('Samoa', 'WS', 'WSM', 882, 'ISO 3166-2:WS', 'Oceania', 'Polynesia', NULL, 9, 61, NULL),
('San Marino', 'SM', 'SMR', 674, 'ISO 3166-2:SM', 'Europe', 'Southern Europe', NULL, 150, 39, NULL),
...
('Serbia', 'RS', 'SRB', 688, 'ISO 3166-2:RS', 'Europe', 'Southern Europe', NULL, 150, 39, NULL),
...
('Singapore', 'SG', 'SGP', 702, 'ISO 3166-2:SG', 'Asia', 'South-eastern Asia', NULL, 142, 35, NULL),
...
('Slovenia', 'SI', 'SVN', 705, 'ISO 3166-2:SI', 'Europe', 'Southern Europe', NULL, 150, 39, NULL),
('Solomon Islands', 'SB', 'SLB', 90, 'ISO 3166-2:SB', 'Oceania', 'Melanesia', NULL, 9, 54, NULL),
...
('South Georgia and the South Sandwich Islands', 'GS', 'SGS', 239, 'ISO 3166-2:GS', NULL, NULL, NULL, NULL, NULL, NULL),
('South Sudan', 'SS', 'SSD', 728, 'ISO 3166-2:SS', 'Africa', 'Sub-Saharan Africa', 'Eastern Africa', 2, 202, 14),
('Spain', 'ES', 'ESP', 724, 'ISO 3166-2:ES', 'Europe', 'Southern Europe', NULL, 150, 39, NULL),
('Sri Lanka', 'LK', 'LKA', 144, 'ISO 3166-2:LK', 'Asia', 'Southern Asia', NULL, 142, 34, NULL),
...
('Taiwan, Province of China', 'TW', 'TWN', 158, 'ISO 3166-2:TW', 'Asia', 'Eastern Asia', NULL, 142, 30, NULL),
...
('Thailand', 'TH', 'THA', 764, 'ISO 3166-2:TH', 'Asia', 'South-eastern Asia', NULL, 142, 35, NULL),
('Timor-Leste', 'TL', 'TLS', 626, 'ISO 3166-2:TL', 'Asia', 'South-eastern Asia', NULL, 142, 35, NULL),
('Togo', 'TG', 'TGO', 768, 'ISO 3166-2:TG', 'Africa', 'Sub-Saharan Africa', 'Western Africa', 2, 202, 11),
('Tokelau', 'TK', 'TKL', 772, 'ISO 3166-2:TK', 'Oceania', 'Polynesia', NULL, 9, 61, NULL),
('Tonga', 'TO', 'TON', 776, 'ISO 3166-2:TO', 'Oceania', 'Polynesia', NULL, 9, 61, NULL),
...
('Tuvalu', 'TV', 'TUV', 798, 'ISO 3166-2:TV', 'Oceania', 'Polynesia', NULL, 9, 61, NULL),
...
('United States of America', 'US', 'USA', 840, 'ISO 3166-2:US', 'Americas', 'Northern America', NULL, 19, 21, NULL),
('United States Minor Outlying Islands', 'UM', 'UMI', 581, 'ISO 3166-2:UM', NULL, NULL, NULL, NULL, NULL, NULL),
...
('Vanuatu', 'VU', 'VUT', 548, 'ISO 3166-2:VU', 'Oceania', 'Melanesia', NULL, 9, 54, NULL),
...
('Viet Nam', 'VN', 'VNM', 704, 'ISO 3166-2:VN', 'Asia', 'South-eastern Asia', NULL, 142, 35, NULL),
...
('Wallis and Futuna', 'WF', 'WLF', 876, 'ISO 3166-2:WF', 'Oceania', 'Polynesia', NULL, 9, 61, NULL),
...
-- Enable RLS on countries table (though it's reference data, we still want security)
ALTER TABLE countries ENABLE ROW LEVEL SECURITY;

-- Create policy to allow everyone to read countries (reference data)
