...
export const ContractualRoadmap = () => {
  ...
  const pathBBullets = [
    ...
    "The client handles the placement fee directly with Fractional First.",
  ]
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <div className="grid grid-cols-1 justify-items-center gap-3 w-auto">
            <SharedStepCard
              ...
              subtitle="One-time acceptance for all future engagements"
            />
          ...
          <ArrowDown className="h-5 w-5 text-primary/60" />
          <p className="text-xs text-muted-foreground font-medium">You can choose to receive one of both types of opportunities. Fractional First facilitates both paths so you're in good hands.</p>
