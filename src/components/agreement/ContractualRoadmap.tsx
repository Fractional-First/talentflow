...
const SharedStepCard = ({ 
  ...
  <div className="bg-primary/10 border border-primary/20 rounded-lg p-3 w-full flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
    ...
    <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
      ...
      <p className="text-xs text-muted-foreground mt-0.5 whitespace-pre-line">{subtitle}</p>
    </div>
  </div>
)
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <div className="grid grid-cols-1 justify-items-center gap-3 w-auto">
            <SharedStepCard
              ...
              subtitle={"Accept once to cover your current and all future leadership roles,\nremoving the friction of future paperwork."}
            />
