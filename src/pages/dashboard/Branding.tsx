...
import { ArrowRight, ArrowLeft, Sparkles, Lock, Star, Users, Award, BookOpen } from 'lucide-react';
...
const Branding = () => {
  ...
  const steps: Step[] = [
    ...
    { id: 5, name: 'Branding', description: 'Enhance your profile', status: 'current' },
  ...
  const brandingTools = [
    {
      ...
      description: 'Discover your work style, strengths, and ideal work environment with our comprehensive personality assessment.',
      icon: Users,
      free: true,
    ...
    },
    {
      ...
      description: 'Get insights on your skills and discover areas for improvement and development.',
      icon: Award,
      free: true,
      imageSrc: 'https://images.unsplash.com/photo-1525130413817-d45c1d127c42?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1770&q=80'
    },
    {
      id: 3,
      title: 'Career Coaching',
      description: 'Connect with a career coach who will provide personalized guidance and feedback on your professional journey.',
      icon: Star,
      free: false,
      premium: true,
    ...
    },
    {
      ...
      description: 'Learn how to build and communicate your personal brand to stand out in the job market.',
      icon: BookOpen,
      free: false,
      imageSrc: 'https://images.unsplash.com/photo-1529156069898-49953e39b3ac?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1774&q=80'
    }
  ];
  ...
  const handleContinue = () => {
    ...
    setTimeout(() => {
      ...
      navigate('/dashboard/job-matching');
    }, 1000);
  };
      ...
      <div className="space-y-6">
        <StepCard>
          <StepCardHeader>
            ...
            <StepCardDescription>
              Take advantage of our tools to enhance your professional brand and increase your chances of finding the perfect match
            </StepCardDescription>
          </StepCardHeader>
        ...
        <StepCard>
          <StepCardHeader>
            ...
            <StepCardDescription>
              Get access to all branding tools and premium features to maximize your opportunities
            </StepCardDescription>
          </StepCardHeader>
              ...
              <div className="flex items-start mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mb-3">
                    Unlock additional features and tools to enhance your professional journey
                  </p>
