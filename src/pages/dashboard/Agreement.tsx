...
import { ArrowRight, ArrowLeft, FileText, Shield, Info } from 'lucide-react';
      ...
      <div className="space-y-6">
              ...
              <TabsContent value="msa" className="mt-6">
                ...
                <ScrollArea className="h-[400px] rounded-lg border p-4">
                  <div className="space-y-4 text-sm">
                    ...
                    <h4 className="font-semibold mt-6">3. FEES</h4>
                    <p>3.1 Basic access to the Platform is provided free of charge.</p>
                    <p>3.2 Premium features and services may be offered for additional fees, which will be clearly disclosed before Talent elects to use such features or services.</p>
                    <p>3.3 If Talent accepts employment or enters into a service agreement with a Client introduced through the Platform, Company may charge a placement fee as detailed in the fee schedule available on the Platform.</p>
                    
                    <h4 className="font-semibold mt-6">4. TERM AND TERMINATION</h4>
                    <p>4.1 This Agreement commences on the date of Talent's electronic acceptance and continues until terminated in accordance with the terms herein.</p>
                    <p>4.2 Either party may terminate this Agreement at any time for any reason upon written notice to the other party.</p>
                    <p>4.3 Upon termination, Talent's right to use the Platform will immediately cease, and Company may delete Talent's account and all associated information.</p>
                    
                    <h4 className="font-semibold mt-6">5. CONFIDENTIALITY</h4>
                    ...
                    <p>5.3 This obligation of confidentiality will survive the termination of this Agreement for a period of three (3) years.</p>
                    
                    <h4 className="font-semibold mt-6">6. LIMITATION OF LIABILITY</h4>
                    <p>6.1 IN NO EVENT SHALL COMPANY BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, EXEMPLARY, OR CONSEQUENTIAL DAMAGES ARISING OUT OF OR IN CONNECTION WITH THIS AGREEMENT, EVEN IF COMPANY HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.</p>
                    <p>6.2 COMPANY'S TOTAL CUMULATIVE LIABILITY UNDER THIS AGREEMENT SHALL NOT EXCEED THE AMOUNT OF FEES PAID BY TALENT TO COMPANY DURING THE SIX (6) MONTHS PRECEDING THE EVENT GIVING RISE TO LIABILITY.</p>
                    
                    <h4 className="font-semibold mt-6">7. MISCELLANEOUS</h4>
                    <p>7.1 This Agreement constitutes the entire agreement between the parties with respect to the subject matter hereof and supersedes all prior or contemporaneous communications and proposals, whether oral or written.</p>
                    <p>7.2 This Agreement shall be governed by and construed in accordance with the laws of the State of Delaware, without regard to its conflict of law principles.</p>
                    <p>7.3 Any dispute arising out of or relating to this Agreement shall be resolved by binding arbitration in accordance with the rules of the American Arbitration Association.</p>
                    <p>7.4 If any provision of this Agreement is found to be unenforceable or invalid, that provision shall be limited or eliminated to the minimum extent necessary so that this Agreement shall otherwise remain in full force and effect and enforceable.</p>
                    <p>7.5 This Agreement may not be assigned by Talent without the prior written approval of Company but may be assigned by Company without consent to a successor in interest.</p>
        ...
        <StepCard>
          <StepCardHeader>
            ...
            <StepCardDescription>
              By clicking "Sign & Continue" below, you are electronically signing and agreeing to the Master Services Agreement and acknowledging our Privacy Policy.
            </StepCardDescription>
          </StepCardHeader>
          ...
          <StepCardContent>
            <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
              <p className="text-sm">
                Your electronic signature will be as legally binding as a physical signature. This Agreement constitutes the entire agreement between you and TalentFlow Inc. regarding your use of our services.
              </p>
            </div>
          </StepCardContent>
          ...
          <StepCardFooter className="flex justify-between pt-6">
            ...
            <Button 
              ...
              disabled={isSubmitting || !hasAgreed || !hasReadPrivacy}
              className={!hasAgreed || !hasReadPrivacy ? "opacity-50 cursor-not-allowed" : ""}
            >
