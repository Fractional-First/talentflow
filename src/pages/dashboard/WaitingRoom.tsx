...
import { ArrowLeft, Briefcase, Building, Clock, Edit, Bell, CheckCircle, Search, Filter } from 'lucide-react';
...
const WaitingRoom = () => {
  ...
  const steps: Step[] = [
    ...
    { id: 6, name: 'Job Matching', description: 'Get matched to jobs', status: 'completed' }
  ];
      ...
      <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div>
                <div className="flex items-center">
                  ...
                  <Badge className="ml-2 bg-primary animate-pulse-soft">Actively Looking</Badge>
                </div>
                <StepCardDescription>
                  Track your job applications and continue exploring opportunities
                </StepCardDescription>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <Card className="glassmorphism transition-all duration-300 hover:shadow-glass-hover animate-scale-in">
                <CardContent className="p-6">
                  ...
                  <div className="text-3xl font-medium">{jobApplications.length}</div>
                  <p className="text-sm text-muted-foreground mt-1">Active applications</p>
                </CardContent>
              </Card>
              
              <Card className="glassmorphism transition-all duration-300 hover:shadow-glass-hover animate-scale-in" style={{ animationDelay: '0.1s' }}>
                <CardContent className="p-6">
                  <div className="flex items-center mb-2">
                  ...
                  <p className="text-sm text-muted-foreground mt-1">Upcoming interviews</p>
                </CardContent>
              </Card>
              
              <Card className="glassmorphism transition-all duration-300 hover:shadow-glass-hover animate-scale-in" style={{ animationDelay: '0.2s' }}>
                <CardContent className="p-6">
                  <div className="flex items-center mb-2">
                  ...
                  <p className="text-sm text-muted-foreground mt-1">Jobs for later</p>
                </CardContent>
              </Card>
            </div>
            ...
            <Tabs defaultValue="applications">
              ...
              <TabsContent value="applications" className="space-y-4">
                ...
                {jobApplications.map(job => (
                  <Card key={job.id} className="overflow-hidden animate-slide-up">
                    <CardContent className="p-6">
              ...
              <TabsContent value="explore" className="space-y-4">
                <div className="text-center py-8">
                  ...
                  <h3 className="font-medium text-lg mb-2">Explore New Opportunities</h3>
                  <p className="text-muted-foreground max-w-md mx-auto mb-6">
                    Discover new job opportunities that match your skills, experience, and preferences.
                  </p>
                  <Button onClick={() => navigate('/dashboard/job-matching')}>
                    Search Jobs
                  </Button>
                </div>
              </TabsContent>
        ...
        <StepCard>
          <StepCardHeader>
            ...
            <StepCardDescription>
              Your dedicated support team is here to help you throughout your job search journey
            </StepCardDescription>
          </StepCardHeader>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex items-center space-x-4 p-4 rounded-lg border animate-fade-in">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Talent Success Manager</p>
              ...
              <div className="flex items-center space-x-4 p-4 rounded-lg border animate-fade-in" style={{ animationDelay: '0.1s' }}>
                <Avatar className="h-12 w-12">
                  <AvatarFallback className="bg-primary/10 text-primary">
                    MS
                  </AvatarFallback>
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Recruiter Specialist</p>
                  <Button variant="link" className="p-0 h-auto text-sm">
                    Send Message
                  </Button>
                </div>
